...
control_rates = f'{test_data_folder}meth-tab-n100-m200.txt.CEM-rates-MCvsPM.csv'
control_ages = f'{test_data_folder}meth-tab-n100-m200.txt.CEM-ages-MCvsPM.csv'
...
test_em = MethylationEM(methylation_table=test_meth_table,
                        ...
                        output_path='tests/test_data/test_output')

control_age_df = pd.read_csv(control_ages, sep=',', header=True, index_col=0)
control_rate_df = pd.read_csv(control_rates, sep=',', header=True, index_col=0)
